      ...
      >
          <div class="historico-grid">
            <div class="historico-cabecalho">
              ...
              <span class="data">{{ formatarDataBrasilia(item.createdAt_local || item.createdAt) }}</span>
            </div>
...
export default {
      ...
      formatarContrato(contrato) {
        return `
          <div class="detalhes-contrato-horizontal">
            <span class="detalhes-item"><strong>Número:</strong> ${contrato.numeroContrato || 'N/A'}</span> |
            <span class="detalhes-item"><strong>Responsável:</strong> ${contrato.responsavel || 'N/A'}</span> |
            <span class="detalhes-item"><strong>Empresas:</strong> ${contrato.empresas || 'N/A'}</span> |
            <span class="detalhes-item"><strong>Início:</strong> ${contrato.inicioPrazo || 'N/A'}</span> |
            <span class="detalhes-item"><strong>Término:</strong> ${contrato.terminoPrazo || 'N/A'}</span> |
            <span class="detalhes-item"><strong>Valor:</strong> ${this.formatarValor(contrato.valor) || 'N/A'}</span> |
            <span class="detalhes-item"><strong>Situação:</strong> ${contrato.situacao || 'N/A'}</span> |
            <span class="detalhes-item"><strong>Observações:</strong> ${contrato.observacoes || 'N/A'}</span>
          </div>
        `;
      },
      formatarValor(valor) {
  ...
  .usuario strong, .detalhes strong {
    color: #333;
    font-weight: 600;
  }
